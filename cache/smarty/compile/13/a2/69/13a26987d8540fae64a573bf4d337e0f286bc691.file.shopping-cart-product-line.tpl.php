<?php /* Smarty version Smarty-3.1.13, created on 2013-07-16 18:06:26
         compiled from "C:\wamp\www\prestashop-sklodekor\themes\sklodekor\shopping-cart-product-line.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1376351e56f821fe942-67311874%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '13a26987d8540fae64a573bf4d337e0f286bc691' => 
    array (
      0 => 'C:\\wamp\\www\\prestashop-sklodekor\\themes\\sklodekor\\shopping-cart-product-line.tpl',
      1 => 1373574106,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1376351e56f821fe942-67311874',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_51e56f82a6b564_92327571',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51e56f82a6b564_92327571')) {function content_51e56f82a6b564_92327571($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\wamp\\www\\prestashop-sklodekor\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
<?php if (!empty($_smarty_tpl->tpl_vars['product']->value['gift'])){?>_gift<?php }?>_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_kovanie']);?>
_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_vzor']);?>
" class="cart_item<?php if (isset($_smarty_tpl->tpl_vars['productLast']->value)&&$_smarty_tpl->tpl_vars['productLast']->value&&(!isset($_smarty_tpl->tpl_vars['ignoreProductLast']->value)||!$_smarty_tpl->tpl_vars['ignoreProductLast']->value)){?> last_item<?php }elseif(isset($_smarty_tpl->tpl_vars['productFirst']->value)&&$_smarty_tpl->tpl_vars['productFirst']->value){?> first_item<?php }?><?php if (isset($_smarty_tpl->tpl_vars['customizedDatas']->value[$_smarty_tpl->tpl_vars['productId']->value][$_smarty_tpl->tpl_vars['productAttributeId']->value])&&$_smarty_tpl->tpl_vars['quantityDisplayed']->value==0){?> alternate_item<?php }?> address_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_address_delivery']);?>
...
<?php if ($_smarty_tpl->tpl_vars['product']->value['kovanie_popis']){?>, <?php echo $_smarty_tpl->tpl_vars['product']->value['kovanie_popis'];?>
<?php }?><?php if ($_smarty_tpl->tpl_vars['product']->value['vzor_popis']){?>, <?php echo $_smarty_tpl->tpl_vars['product']->value['vzor_popis'];?>
<?php }?></a><?php }?>
	</td>
...
_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product_attribute'];?>
_<?php if ($_smarty_tpl->tpl_vars['quantityDisplayed']->value>0){?>nocustom<?php }else{ ?>0<?php }?>_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_address_delivery']);?>
_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_kovanie']);?>
_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_vzor']);?>
...
<?php $_tmp3=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_kovanie']);?>
<?php $_tmp4=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_vzor']);?>
<?php $_tmp5=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp1."&amp;ipa=".$_tmp2."&amp;id_address_delivery=".$_tmp3."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)."&amp;kovanie_id=".$_tmp4."&amp;vzor_id=".$_tmp5);?>
...
<?php $_tmp8=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_kovanie']);?>
<?php $_tmp9=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_vzor']);?>
<?php $_tmp10=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp6."&amp;ipa=".$_tmp7."&amp;id_address_delivery=".$_tmp8."&amp;op=down&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)."&amp;kovanie_id=".$_tmp9."&amp;vzor_id=".$_tmp10);?>
...
<?php $_tmp13=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_kovanie']);?>
<?php $_tmp14=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_vzor']);?>
<?php $_tmp15=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp11."&amp;ipa=".$_tmp12."&amp;id_address_delivery=".$_tmp13."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)."&amp;kovanie_id=".$_tmp14."&amp;vzor_id=".$_tmp15);?>
