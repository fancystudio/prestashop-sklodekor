<?php /* Smarty version Smarty-3.1.13, created on 2013-07-16 18:06:24
         compiled from "C:\wamp\www\prestashop-sklodekor\themes\sklodekor\shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2410351e56f80abb2e3-50589792%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3a59632358d7b14678e61a91a0f8c851f8219a38' => 
    array (
      0 => 'C:\\wamp\\www\\prestashop-sklodekor\\themes\\sklodekor\\shopping-cart.tpl',
      1 => 1373574094,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2410351e56f80abb2e3-50589792',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_51e56f81bf2c93_47984269',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51e56f81bf2c93_47984269')) {function content_51e56f81bf2c93_47984269($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\wamp\\www\\prestashop-sklodekor\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
<?php $_tmp6=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_kovanie']);?>
<?php $_tmp7=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_vzor']);?>
<?php $_tmp8=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp5."&amp;ipa=".$_tmp6."&amp;id_customization=".((string)$_smarty_tpl->tpl_vars['id_customization']->value)."&amp;id_address_delivery=".((string)$_smarty_tpl->tpl_vars['product']->value['id_address_delivery'])."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)."&amp;kovanie_id=".$_tmp7."&amp;vzor_id=".$_tmp8);?>
