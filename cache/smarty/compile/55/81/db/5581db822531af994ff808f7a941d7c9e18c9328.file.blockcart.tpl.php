<?php /* Smarty version Smarty-3.1.13, created on 2013-07-11 22:18:13
         compiled from "/Applications/MAMP/htdocs/prestashop-sklodekor/themes/sklodekor/modules/blockcart/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:92326031851df1305f181d3-92011761%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5581db822531af994ff808f7a941d7c9e18c9328' => 
    array (
      0 => '/Applications/MAMP/htdocs/prestashop-sklodekor/themes/sklodekor/modules/blockcart/blockcart.tpl',
      1 => 1373396672,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '92326031851df1305f181d3-92011761',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_51df130650be82_07159804',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51df130650be82_07159804')) {function content_51df130650be82_07159804($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/Applications/MAMP/htdocs/prestashop-sklodekor/tools/smarty/plugins/modifier.escape.php';
if (!is_callable('smarty_modifier_replace')) include '/Applications/MAMP/htdocs/prestashop-sklodekor/tools/smarty/plugins/modifier.replace.php';
?>
...
<?php }else{ ?>0<?php }?>_<?php if ($_smarty_tpl->tpl_vars['product']->value['id_kovanie']){?><?php echo $_smarty_tpl->tpl_vars['product']->value['id_kovanie'];?>
<?php }else{ ?>0<?php }?>_<?php if ($_smarty_tpl->tpl_vars['product']->value['id_vzor']){?><?php echo $_smarty_tpl->tpl_vars['product']->value['id_vzor'];?>
...
_<?php if ($_smarty_tpl->tpl_vars['product']->value['id_kovanie']){?><?php echo $_smarty_tpl->tpl_vars['product']->value['id_kovanie'];?>
<?php }else{ ?>0<?php }?>_<?php if ($_smarty_tpl->tpl_vars['product']->value['id_vzor']){?><?php echo $_smarty_tpl->tpl_vars['product']->value['id_vzor'];?>
<?php }else{ ?>0<?php }?>" class="<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['myLoop']['first']){?>first_item<?php }elseif($_smarty_tpl->getVariable('smarty')->value['foreach']['myLoop']['last']){?>last_item<?php }else{ ?>item<?php }?>">
...
_<?php if ($_smarty_tpl->tpl_vars['product']->value['id_kovanie']){?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_kovanie']);?>
<?php }else{ ?>0<?php }?>_<?php if ($_smarty_tpl->tpl_vars['product']->value['id_vzor']){?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_vzor']);?>
<?php }else{ ?>0<?php }?>"><a class="ajax_cart_block_remove_link" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product']);?>
<?php $_tmp1=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product_attribute']);?>
<?php $_tmp2=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp1."&amp;ipa=".$_tmp2."&amp;id_customization=".((string)$_smarty_tpl->tpl_vars['id_customization']->value)."&amp;token=".((string)$_smarty_tpl->tpl_vars['static_token']->value)."&amp;id_kovanie=".((string)$_smarty_tpl->tpl_vars['product']->value['id_kovanie'])."&amp;id_vzor=".((string)$_smarty_tpl->tpl_vars['product']->value['id_vzor']),true);?>
" rel="nofollow"> </a></div>
