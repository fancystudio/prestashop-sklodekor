...
echo'<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml">
					...
					<legend><a style="margin: 0;padding: 0.2em 0.5em;border: 1px solid #DFD5C3;background: #FFF6D3;font-weight: bold;text-align: center;">'.trans('Your logs').'</a></legend>
 ...
 $val = str_replace("'","_", $val);
			$url=  '<a href="#" onclick=" document.location.href=\''.$val.'\'"><img src="../../../img/admin/details.gif" alt="View" title="'.trans('View this log').'" width="16px"><a href="#" onclick="if(confirm(\''.trans('Are you sure to delete this logs').'? ('.$val.')\')) document.location.href=\'supp.php?key='.$Key.'&file='.$val.'\'"><img src="../../../img/admin/delete.gif" alt="Delete" title="'.trans('Delete this log').'" width="16px"></a>&nbsp;&nbsp;'.$val.'<br/>';
			echo $url;}	
