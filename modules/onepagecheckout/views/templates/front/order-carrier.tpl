        ...
        <div id="opc_delivery_methods" class="opc-main-block">
            ...
            {if isset($opc_config.order_msg) && $opc_config.order_msg && !isset($onlyCartSummary)}
                ...
                <div>
                    ...
                    <p><textarea style="width: 97%" rows="3" name="message" id="message"
                                 placeholder="{l s='If you would like to add a comment about your order, please write it here.' mod='onepagecheckout'}">{if isset($oldMessage)}{$oldMessage}{/if}</textarea>
                    </p>
                </div>
            {/if}
