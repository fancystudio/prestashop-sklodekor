    ...
    <script type="text/javascript">
            ...
            function setDeliveryAddress() {
                if (!$("#invoice_address").is(":checked"))
                    setPersonalDetailsAddress($('#personal_info_delivery p, #personal_info_invoice p'), '');
                else
                    setPersonalDetailsAddress($('#personal_info_delivery p'), '');
            }

            function setInvoiceAddress() {
                if ($("#invoice_address").is(":checked"))
                    setPersonalDetailsAddress($('#personal_info_invoice p'), '_invoice');
                else
                    setPersonalDetailsAddress($('#personal_info_invoice p'), '');
            }
            ...
            function setPersonalDetailsPayment() {
                if ($('input[name=id_payment_method]:checked').length) {
                    $('#personal_info_payment p').html($('input[name=id_payment_method]:checked').parent().next().next().html());
                }
            }
            ...
            $(function () {
                ...
                //$('input[name=id_payment_method]').click(setPersonalDetailsPayment);
