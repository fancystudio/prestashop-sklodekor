...
<div id="header_user">
	<ul id="header_nav">
		...
		<li id="shopping_cart">
			<a href="{$link->getPageLink($order_process, true)}" title="{l s='View my shopping cart' mod='blockuserinfo'}" rel="nofollow"><span class="kosik">{l s='Cart' mod='blockuserinfo'}<span>
			...
			<span class="ajax_cart_no_product{if $cart_qties > 0} hidden{/if}">{l s='' mod='blockuserinfo'}</span>
			</a>
		</li>
		{/if}
